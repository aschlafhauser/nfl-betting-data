...
for(const [name,gate] of Object.entries(manifest.gates||{})){if(String(gate.status||'').toUpperCase()==='FAIL')failures.push(`${name}: failed`)}
...
console.log(JSON.stringify({season,week,status:failures.length?'FAIL':'PASS',manifestStatus:manifest.status,failures},null,2));
