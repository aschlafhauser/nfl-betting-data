...
console.log(`NFL weekly manifest ${status}: ${expected} games, ${deep.completedGameCount||0} Deep Dives, ${classIds.size} classified, ${snapshotFailures.length} hard final-snapshot failures, ${blockingFailures.length} blocking failures.`);
